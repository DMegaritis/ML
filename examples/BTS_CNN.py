...
file_path = r'C:\Users\klch3\PycharmProjects\MLTable\data/cleaned_aggregated_BTS24_first_60_all_vars.npy'
features = np.load(file_path)
file_path = r'C:\Users\klch3\PycharmProjects\MLTable\data/target_BTS24_first_60_all_vars.npy'
